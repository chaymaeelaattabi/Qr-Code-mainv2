          ...
          child: Center(
            child: Column(
              children: <Widget>[
                ...
                Text(
                  "En utilisant le bluetooth de votre telephone,notre application detecte les telephone des autres utilisateurs qui restent a proximite du votre.",
                  textAlign: TextAlign.center,
                  style: TextStyle(
                    fontSize: 15,
                    color: Colors.white,
                ...
                Text(
                  "vous serez informe si vous avez ete a proximite d'un utilisateur teste positif a la COVID-19.",
                  textAlign: TextAlign.center,
                  style: TextStyle(
                    fontSize: 15,
                    color: Colors.white,
                ...
                Text(
                  "Je protege mes proches et les autre",
                  textAlign: TextAlign.center,
                  style: TextStyle(
                    fontSize: 17,
                    fontWeight: FontWeight.bold,
